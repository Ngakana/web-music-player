...
import amapiano_lofi_1 from "store/amapiano-lofi-1.mp3";
import metrorail from "store/metrorail.jpg"

import amapiano_lofi_2 from "store/amapiano-lofi-2.mp3";
import dance from "store/dance.jpg"

import amapiano_hits from "store/amapiano.mp3";
...
function musicStore() {
    ...
    return [
        {
            artwork: metrorail,
            audio: amapiano_lofi_1,
            song_title: "amapiano lofi 🎹",
            artists: "chill gang",
        ...
        {
            artwork: dance,
            audio: amapiano_lofi_2,
            song_title: "lofi sghubhu 🎹",
            artists: "chill gang:yt:",
            colors: ['#8e6353', '#ccc8c5'],
            id: uuidv4(),
            active: true
        },
